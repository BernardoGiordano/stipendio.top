...
import { ADDIZIONALI_REGIONALI, ADDIZIONALI_COMUNALI } from '../addizionali';
...
/** Soglie esenzione fringe benefit 2025 */
...
/** Soglia buoni pasto elettronici 2025 */
const BUONI_PASTO_ELETTRONICI = 8.0;

/** Percentuali calcolo fringe benefit auto aziendale uso promiscuo (2025) */
...
export class Calculator2025 implements StipendioCalculator {
  calcolaStipendioNetto(input: InputCalcoloStipendio): OutputCalcoloStipendio {
    ...
    // Stipendio netto mensile (include welfare netto mensile)
